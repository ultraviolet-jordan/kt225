...
value class MapSquareLandTile(
    ...
    constructor(
        ...
        collision: Int,
        underlayId: Int
    ) : this(((height and 0xff) or ((overlayId and 0xff) shl 17) or ((overlayPath and 0xff) shl 22)).toLong() or (((overlayRotation and 0xff) or ((collision and 0xff) shl 8) or ((underlayId and 0xff) shl 16)).toLong() shl 24))

    val height: Int get() = (packed and 0xff).toInt()
    val overlayId: Int get() = (packed shr 17 and 0xff).toInt()
    val overlayPath: Int get() = (packed shr 22 and 0xff).toInt()
